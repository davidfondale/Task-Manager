...
const task: Task = tasks.find(t=>t.id===i);
...
const handleSubmit = (e: React.FormEvent<HTMLFormElement>) =>{
  e.preventDefault();
  dispatch({type: "UPDATE", payload: taskItem});
  setSubmitted(true);
};
...
return (
  <Container className="mt-5">
    {submitted && <Alert variant="success" dismissible>{taskItem.title} updated successfully!</Alert>}
